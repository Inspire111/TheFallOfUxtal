...
public class DamageZoneMulti : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            PlayerStatsMulti player = other.GetComponent<PlayerStatsMulti>();
            if (player != null)
            {
    ...
    private IEnumerator ApplyDamageOverTime(PlayerStatsMulti player)
    {
